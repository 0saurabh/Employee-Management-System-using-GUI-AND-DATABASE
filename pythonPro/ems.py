...
window.configure(fg_color='#161C38')
logo=CTkImage(Image.open('bg.png'),size=(930,158))
logoLable=CTkLabel(window,image=logo,text='')
logoLable.grid(row=0,column=0,columnspan=2)



leftFrame=CTkFrame(window,fg_color='#161C38')
...
phoneLabel.grid(row=2,column=0,padx=20,sticky='w')
...
role_option=['web development','cloud architect','technical writer','network engineer','data scientist','business analyst']
roleBox=CTkComboBox(leftFrame,values=role_option,width=180,font=('arial',15,'bold'),state='readonly')
